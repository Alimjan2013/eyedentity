...
const VotingComponent = () => {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px' }}>
      <h1>Come to vote</h1>
      <button onClick={handleButtonClick} style={{ padding: '10px 20px', margin: '20px 0' }}>
        Show My Info
      </button>
      {loading && (
        <div style={{ marginTop: '20px' }}>
          <div className="loading-spinner" style={{ border: '4px solid #f3f3f3', borderRadius: '50%', borderTop: '4px solid #3498db', width: '40px', height: '40px', animation: 'spin 1s linear infinite', margin: 'auto' }}></div>
        </div>
      )}
      {!loading && info && (
        <div style={{ marginTop: '20px' }}>
